...
class GraphExtractor:
    ...
    async def __call__(
        ...
        #print(self._tuple_delimiter_key)
        #print(f"v1: {prompt_variables.get(self._tuple_delimiter_key, DEFAULT_TUPLE_DELIMITER)}")
        #print(f"v2: {prompt_variables.get(self._record_delimiter_key, DEFAULT_RECORD_DELIMITER)}")
    ...
    async def _process_document( # extract entities from a single document. if max_gleanings is set, it will repeat the extraction until max_gleanings is reached
